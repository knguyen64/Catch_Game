...
void Player::setOffset(sf::RenderWindow& window)
{
    ...
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space) || isEnabled(JUMPED)) {
        offsetY = -40;
        enableState(JUMPED);
